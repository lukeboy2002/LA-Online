        ...
        <article class="px-6 py-3">
            <header class="flex justify-between items-center mb-2">
                <div class="flex items-center">
                    <p class="inline-flex items-center mr-3 text-sm text-secondary font-semibold">
            ...
            @else
                <div class="flex justify-between items-end">
                    <div class="text-primary-muted text-xs prose dark:prose-invert prose-sm max-w-none">
                ...
                <div class="flex justify-between items-center h-screen max-w-md mx-auto">
                    <div class="bg-background border border-secondary/30 relative rounded-lg shadow-sm w-full">
                        ...
                        <div class="p-4 md:p-5">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-primary-muted">{{ __('Are you sure you want to delete these comment?') }}
                            </h3>
