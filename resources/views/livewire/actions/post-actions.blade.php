<div>
    <div class="flex items-center gap-2 mr-2">
        @can('update', $post)
            <x-link.icon href="{{ route('post.edit', $post->slug) }}" icon="edit" class="text-edit"/>
        @endcan
                ...
                <div class="flex justify-between items-center h-screen max-w-md mx-auto">
                    <div class="bg-background border border-secondary/30 relative rounded-lg shadow-sm w-full">
                        ...
                        <div class="p-4 md:p-5">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-primary-muted">{{ __('Are you sure you want to delete this post and all associated comments?') }}
                            </h3>
