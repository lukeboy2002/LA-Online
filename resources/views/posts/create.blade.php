    ...
    <x-card.default>
        <form action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="flex-row space-y-6 w-full  lg:w-3/4 px-3">
                <div>
                    <x-form.label for="title" value="{{ __('Titlel') }}"/>
                ...
                <div>
                    <x-form.label for="content" value="{{ __('Text') }}"/>
                    ...
                    <livewire:components.tiptap-editor
                            ...
                            :media-model="$mediaModel ?? null"
                            media-collection="tiptap"
                    />
                    <x-form.error for="content" class="mt-2"/>
                </div>
            ...
            <aside class="w-full space-y-4 lg:w-1/4 flex-col pt-4 px-3 gap-4">
                <div>
                    <x-heading.sub>{{ __('Post Image') }}</x-heading.sub>
                ...
                <div>
                    <x-heading.sub>{{ __('Category') }}</x-heading.sub>
                ...
                <div>
                    <x-heading.sub>{{ __('Publication date') }}</x-heading.sub>
                    <x-form.input
                            class="w-full"
                            type="date"
                            name="published_at"
